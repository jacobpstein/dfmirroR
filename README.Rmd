...
You can install also the CRAN version of the package, but it's not as good as the development version:
...
### Citations
This package is indebted to the great [`fitdistrplus`](https://cran.r-project.org/web/packages/fitdistrplus/) package, which allows `dfmirroR` to dynamically mimic the distribution of input data. For more, see: 
...
David Meyer, et al. [e1071](https://cran.r-project.org/web/packages/e1071/).

The `MASS` package also provides some functionality. Learn more here:
Venables WN, Ripley BD (2002). Modern Applied Statistics with S, Fourth edition. Springer, New York. ISBN 0-387-95457-0, https://www.stats.ox.ac.uk/pub/MASS4/.devtools::check(remote = TRUE, manual = TRUE)
